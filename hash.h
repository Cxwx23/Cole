...
// do not change anything above!
   ...
   int countTotalWords();           // counts the words in the hash table
   int countNonEmpty();             // counts the non-empty lists
   double calcRunningAve();         // calculates running average list length
